...
import { IContext, ContextService, Context, ContextDetailedDto } from './index';
...
export class ContextController {
  ...
  public async create(request: Hapi.Request, h: Hapi.ResponseToolkit) {
    const newContext = request.payload as ContextDetailedDto;
  ...
  public async getDetailsById(request: Hapi.Request, _h: Hapi.ResponseToolkit) {
    ...
    const contextDetails = await this.contextService.getDetailedById(id, owner, request).catch(handleError);
