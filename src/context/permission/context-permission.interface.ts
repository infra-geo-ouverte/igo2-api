...
export type IAnyContextPermissionWithRelations =
  IContextPermissionWithUser | IContextPermissionWithProfil;

export type IAnyContextPermissionOut = (
  IContextPermissionWithUser | IContextPermissionProfil
) & {
  title?: string;
...
export type IAnyContextPermissionIn =
  IContextPermissionUserIn | IContextPermissionProfilIn;
