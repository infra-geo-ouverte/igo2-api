...
export const OgcSelectorFields = ['pushButtons', 'checkboxes', 'radioButtons', 'select', 'autocomplete'] as const;
...
interface OgcFilterIsNullOptions extends OgcFilterAttributeOptions {}
